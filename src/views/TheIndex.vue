  ...
  <div class="index-top">
    ...
    <div class="index-banner">
      <div class="banner-content">
        ...
        <router-link :to="{ path: '/about' }" class="banner-btn">关于我们</router-link>
      </div>
    </div>
  </div>
  <div class="index-bottom">
    <section class="intro-section">
      <h2 class="intro-title h2-title">平台简介</h2>
      <article class="intro-content">
        <p class="intro-text">功以才成，业由才广。</p>
        <p class="intro-text">
          为成为数智化转型咨询服务的引领者，打造国内一流的数智化转型咨询机构及协作平台，
        </p>
        <p class="intro-text">
          中移咨询建立了涵盖中国移动及行业合作伙伴的数字化转型专家库，实现需求与人才的高效匹配及调用。
        </p>
      </article>
    </section>
    ...
    <section class="index-footer">
      Copyright © 2022 中移咨询 All Rights Reserved.
    </section>
  </div>
</template>
...
import fakeData from '@/datas/the_index';
  ...
  .index-banner {
    ...
    .banner-content {
      ...
      .banner-btn {
        ...
        text-align: center;
        line-height: 56px;
        background: linear-gradient(90deg, #ebcbac 0%, #d2b08a 100%);
        border-radius: 38px;
        display: block;
  ...
  .overview-section {
    ...
    .overview-nav {
      ...
      .nav-item {
        ...
        &:last-child {
          background: url(@/assets/images/img-2.png) no-repeat center / cover;
        }
...
:global(.layout-sub-menu .ant-menu.ant-menu-sub.ant-menu-vertical) {
  min-width: 128px;
  padding: 0 4px;
}
